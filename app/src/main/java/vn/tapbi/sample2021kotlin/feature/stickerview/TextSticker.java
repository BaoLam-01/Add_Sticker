...
public class TextSticker extends Sticker {
  ...
  public TextSticker(@NonNull Context context, @Nullable Drawable drawable) {
    ...
    stroke = false;
    shadow = false;
    strokePaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
    strokePaint.setColor(Color.WHITE);
    strokePaint.setTextSize(maxTextSizePixels);
  ...
  @Override public void draw(@NonNull Canvas canvas) {
    ...
    if (shadow) {
      strokePaint.setShadowLayer(10f,2f,4f, getColor(context,R.color.light_gray));
    } else {
  ...
  @NonNull public TextSticker setStrokeColor(@ColorInt int color) {
    strokePaint.setColor(color);
    return this;
  }

  @NonNull public TextSticker setStrokeWidth(float strokeWidth) {
    strokePaint.setStrokeWidth(strokeWidth);
    return this;
  }

  @NonNull public TextSticker setStroke(boolean isStroke) {
    stroke = isStroke;
    return this;
  }
  ...
  public TextSticker setShadowText(Boolean isShadow) {
    shadow = isShadow;
    return this;
  }
  ...
  @NonNull public TextSticker resizeText() {
    ...
    staticLayout =
      ...
      staticLayoutStroke = new StaticLayout(this.text,strokePaint,textRect.width(),alignment,lineSpacingMultiplier,lineSpacingExtra,true);
    return this;
  }
