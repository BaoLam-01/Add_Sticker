...
public abstract class Sticker {
    ...
    @IntDef(flag = true, value = {
            Position.CENTER, Position.TOP, Position.BOTTOM, Position.LEFT, Position.RIGHT,Position.BEARD
    })
    ...
    public void getBoundPoints(@NonNull float[] points) {
        float paddingSticker = 40f;
        if (!isFlippedHorizontally) {
            if (!isFlippedVertically) {
                points[0] = -paddingSticker;
                points[1] = -paddingSticker;
                points[2] = getWidth() + paddingSticker;
                points[3] = -paddingSticker;
                points[4] = -paddingSticker;
                points[5] = getHeight() + paddingSticker;
                points[6] = getWidth() + paddingSticker;
                points[7] = getHeight() + paddingSticker;
            } else {
                points[0] = -paddingSticker;
                points[1] = getHeight() + paddingSticker;
                points[2] = getWidth() + paddingSticker;
                points[3] = getHeight() + paddingSticker;
                points[4] = -paddingSticker;
                points[5] = -paddingSticker;
                points[6] = getWidth() + paddingSticker;
                points[7] = -paddingSticker;
            }
        } else {
            if (!isFlippedVertically) {
                points[0] = getWidth() + paddingSticker;
                points[1] = -paddingSticker;
                points[2] = -paddingSticker;
                points[3] = -paddingSticker;
                points[4] = getWidth() + paddingSticker;
                points[5] = getHeight() + paddingSticker;
                points[6] = -paddingSticker;
                points[7] = getHeight() + paddingSticker;
            } else {
                points[0] = getWidth() + paddingSticker;
                points[1] = getHeight() + paddingSticker;
